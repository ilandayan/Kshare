        ...
        <div className="w-full max-w-[420px]">
          <div className="bg-white rounded-3xl shadow-sm border border-[#e2e5f0]/60 px-8 pt-10 pb-8">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-sm mb-4">
                {done ? (
              ...
              <h1 className="text-xl font-bold text-gray-900 mb-1">
                {done ? "Bienvenue sur Kshare !" : "Créez votre mot de passe"}
              </h1>
              <p className="text-sm text-gray-400 text-center leading-relaxed">
                {done
                  ? "Votre compte est prêt, vous pouvez vous connecter."
                  : "Votre compte a été validé ! Définissez un mot de passe pour accéder à votre espace."}
              </p>
            </div>
            ...
            {done ? (
              ...
              <div className="flex flex-col items-center text-center py-2">
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-6">
                  Votre mot de passe a été créé avec succès. Vous allez être
