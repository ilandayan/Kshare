...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="mission" className="py-16 md:py-24 bg-gradient-to-b from-[#E8ECF8] to-[#F4F5FB]">
        {/* Stats */}
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-[#FAFBFF]">
      ...
      {/* ─────────────── COMMENT ÇA MARCHE ─────────────── */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-[#F4F5FB] to-[#E8ECF8]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* ─────────────── APP MOBILE ─────────────── */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-[#FAFBFF] to-white" id="clients">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
