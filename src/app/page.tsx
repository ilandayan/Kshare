        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] md:items-center gap-y-4 md:gap-x-0">
            {[
              ...
              <div key={item.step} className={`anim-hidden animate-fade-in-up ${item.delay} flex flex-col items-center`}>
                <div className="w-10 h-10 rounded-full bg-white text-[#3744C8] flex items-center justify-center text-sm font-display font-bold shadow-md mb-4">
                  {item.step}
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/15 w-full">
