  ...
  public: {
    Tables: {
      ...
      associations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "associations_validated_by_fkey"
      ...
      baskets: {
        ...
        Relationships: [
          {
            foreignKeyName: "baskets_commerce_id_fkey"
            columns: ["commerce_id"]
            isOneToOne: false
      ...
      commerces: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "commerces_validated_by_fkey"
            columns: ["validated_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      ratings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ratings_commerce_id_fkey"
            columns: ["commerce_id"]
            isOneToOne: false
            referencedRelation: "commerces"
            referencedColumns: ["id"]
      ...
      subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscriptions_commerce_id_fkey"
            columns: ["commerce_id"]
            isOneToOne: true
            referencedRelation: "commerces"
            referencedColumns: ["id"]
      ...
      support_tickets: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "support_tickets_commerce_id_fkey"
            columns: ["commerce_id"]
            isOneToOne: false
            referencedRelation: "commerces"
            referencedColumns: ["id"]
    ...
    Enums: {
      association_status:
        ...
        | "suspended"
        | "archived"
      basket_day: "today" | "tomorrow"
      basket_status: "draft" | "published" | "sold_out" | "expired" | "disabled"
      basket_type: "bassari" | "halavi" | "parve" | "shabbat" | "mix"
      commerce_status:
        | "pending"
        | "validated"
        | "refused"
